...
if(length(A3)>0){
  studyArea_CVG@data$antiguedad_Ab[A3]=studyArea_CVG@data$antiguedad_Ab[A3]-studyArea_CVG@data$antiguedad_Ab[A3]*effectivity_mantenimiento
}

#action 4 New infra Ab.
if(length(A4)>0){
  studyArea_CVG@data$FALTA_IN[A4]=studyArea_CVG@data$FALTA_IN[A4]-studyArea_CVG@data$FALTA_IN[A4]*effectivity_newInfra
}
