...
# here we calculate the consecutive accumulation of two negative events of scarcity
#as protests and social pressure 
...
studyArea_CVG@data$house_modifications_Ab<-numeric(length(studyArea_CVG@data$AGEB_ID))
studyArea_CVG@data$house_modifications_F<-numeric(length(studyArea_CVG@data$AGEB_ID))
