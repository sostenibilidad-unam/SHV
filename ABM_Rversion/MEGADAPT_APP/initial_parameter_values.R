...
#of the argument
sim_id_output=sprintf("effectivity_newInfra=%s-effectivity_mantenimiento=%s-decay_infra=%s-Budget=%s-climate_scenario=%s",effectivity_newInfra,effectivity_mantenimiento,decay_infra,Budget,scenario)
