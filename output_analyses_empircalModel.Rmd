...
studyArea@data$escazes_final_L=numeric(length(escazes_inicial@data$escasez))
...
studyArea@data$escazes_final_M=numeric(length(escazes_inicial@data$escasez))
...
studyArea@data$escazes_final_H=numeric(length(escazes_inicial@data$escasez))
...
writePolyShape(studyArea,"C:/Users/abaezaca/Dropbox (ASU)/MEGADAPT/SHV/outputs/CDMX_vulnerability",proj4string=CRS("+proj=longlat +datum=WGS84"))
...
map<-get_map(location = c(mean(xl),mean(yl)) , maptype = "satellite",source='google',zoom = 1) #location="Mexico City"
map<-get_map(location = ll , maptype = "satellite",source='google',zoom = 10) #location="Mexico 
#create ggplot objects

AI <- ggmap(map, base_layer=ggplot(data=gor_df, aes(x=long,y=lat)),extent = "normal", maprange=FALSE) 
AI <- AI+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=antiguedad_inicial))+
  ...
  scale_fill_continuous("Age Water supply Infrastructure",low="blue",high="red",limits=c(0,65))
  


AF <- ggmap(map, base_layer=ggplot(data=gor_df, aes(x=long,y=lat)),extent = "normal", maprange=FALSE) 
AF <- AF+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=antiguedad_final_M))+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
  scale_fill_continuous("Age Water supply Infrastructure",low="blue",high="red",limits=c(0,65))
  
ADiff <- ggmap(map, base_layer=ggplot(data=gor_df, aes(x=long,y=lat)),extent = "normal", maprange=FALSE) 
ADiff <- ADiff+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.cut3, alpha = 0.2))+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
  scale_fill_manual(name="Level of investment",values=setNames(colors2, levels(studyArea@data$z.cut3)))+labs(title="Expected level of investment")
...
INv_AB_M <- INv_AB_M+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=AB_m_M, alpha = 0.2))+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
  scale_fill_continuous("investments",low="blue",high="red",limits=c(1,241))
...
INv_AB_N <- INv_AB_N+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=IAB_new), alpha = 0.2)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
  scale_fill_continuous("investments",low="blue",high="red",limits=c(0,241))


#################
#cut-off plots
INv_AB_M_cut_L <- ggmap(map, base_layer=ggplot(data=gor_df, aes(x=long,y=lat)),extent = "normal", maprange=FALSE) 
INv_AB_M_cut_L <- INv_AB_M_cut_L+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.AB_m_L), alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
...
INv_AB_N_cut_L <- INv_AB_N_cut_L+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.AB_n_L), alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
...
INv_D_M_cut_L <- INv_D_M_cut_L+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.D_m_L), alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
...
INv_D_N_cut_L <- INv_D_N_cut_L+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.D_n_L), alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
...
INv_AB_M_cut_M <- INv_AB_M_cut_M+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.AB_m_M), alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
...
INv_AB_N_cut_M <- INv_AB_N_cut_M+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.AB_n_M), alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
...
INv_D_M_cut_M <- INv_D_M_cut_M+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.D_m_M), alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
...
INv_D_N_cut_M <- INv_D_N_cut_M+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.D_n_M), alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
...
INv_AB_M_cut_H <- INv_AB_M_cut_H+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.AB_m_H), alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
...
INv_AB_N_cut_H <- INv_AB_N_cut_H+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.AB_n_H), alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
...
INv_D_M_cut_H <- INv_D_M_cut_H+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.D_m_H), alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
...
INv_D_N_cut_H <- INv_D_N_cut_H+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.D_n_H), alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
  scale_fill_manual(name="# of actions",values=setNames(colors4, levels(studyArea@data$z.D_n_H)))+labs(title="S3: High")

png(filename = "investments_INv_D_M_cut_L.png",width = 8,height = 8,units = "in",res=500)

INv_D_M_cut_L
dev.off()

png(filename = "investments_INv_D_M_cut_M.png",width = 8,height = 8,units = "in",res=500)

INv_D_M_cut_M
dev.off()


png(filename = "investments_INv_AB_M_cut_L.png",width = 8,height = 8,units = "in",res=500)

INv_AB_M_cut_L
dev.off()

png(filename = "investments_INv_AB_M_cut_M.png",width = 8,height = 8,units = "in",res=500)

INv_AB_M_cut_M
dev.off()

#png(filename = "expected_level_of_investments_10-50per_resources.png",width = 18,height = 8,units = "in",res=500)
#multiplot(INv_AB_M_cut_L, INv_AB_N_cut_L,INv_AB_M_cut_M ,INv_AB_N_cut_M, cols = 2)
#dev.off()

#writeSpatialShape(x = studyArea,fn = "ABM-FR")

#png(filename = "expected_level_of_investments_10-50per_resources_D.png",width = 18,height = 8,units = "in",res=500)
#multiplot(INv_D_M_cut_L, INv_D_N_cut_L,INv_D_M_cut_M ,INv_D_N_cut_M, cols = 2)
#dev.off()
#png(filename = "expected_level_of_investments.png",width = 12,height = 12,units = "in",res=300)
#ADiff
#dev.off()
#proposal
...
map<-get_map(location = c(mean(xl),mean(yl)) , maptype = "satellite",source='google',zoom = 11) #location="Mexico City"
map<-get_map(location = ll , maptype = "satellite",source='google',zoom = 10) #location="Mexico 
#create ggplot objects

INv_D_N_cut_L <- ggmap(map, base_layer=ggplot(data=gor_df, aes(x=long,y=lat)),extent = "normal", maprange=FALSE) 
INv_D_M_cut_M <- INv_D_M_cut_M+geom_polygon(data=subset(studyArea.df,estado==levels(studyArea.df$estado)[1]),  aes(x=long,y=lat,group=group,fill=z.D_m_M), alpha = 0.5)+
  ...
  scale_fill_manual(name="Investments",values=setNames(colors4, levels(studyArea@data$z.D_m_M)))+labs(title="Maintenance")


INv_D_N_cut_M <- ggmap(map, base_layer=ggplot(data=gor_df, aes(x=long,y=lat)),extent = "normal", maprange=FALSE) 
INv_D_N_cut_M <- INv_D_N_cut_M+geom_polygon(data=subset(studyArea.df,estado==levels(studyArea.df$estado)[1]),  aes(x=long,y=lat,group=group,fill=z.D_n_M), alpha = 0.5)+
  geom_path(data=subset(studyArea.df,estado==levels(studyArea.df$estado)[1]),  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .4) +
  scale_fill_manual(name="Investments",values=setNames(colors4, levels(studyArea@data$z.D_n_M)))+labs(title="New Infrastructure")

png(filename = "C:/Users/abaezaca/Dropbox (ASU)/poposals/expected_level_of_investments.png",width = 8,height = 4,units = "in",res=400)
...
xl=c(-98.8, -99.4)
yl=c(19, 19.8)
map<-get_map(location = c(mean(xl),mean(yl)) , maptype = "satellite",source='google') #location="Mexico City"
...
```{r, echo=FALSE,fig.height=10,fig.width=20}
studyArea@data$escazes_diff_M=(studyArea@data$escazes_inicial - studyArea@data$escazes_final_M)
...
WSI_M<-ggmap(map, base_layer=ggplot(data=gor_df, aes(x=long,y=lat)),extent = "normal", maprange=FALSE) + 
  geom_polygon(data=studyArea.df,aes(long,lat,group=group,fill=escazes_final_M),alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8)  +
  coord_equal() +
...
png(filename = "scarcity_vs_investments.png",width = 18,height = 12,units = "in",res=500)
...
png(filename = "incomeIndex_vs_investments.png",width = 15,height = 8,units = "in",res=500)
P2
dev.off()

png(filename = "incomeIndex_vs_investments_bydelegation.png",width = 18,height = 8,units = "in",res=500)
P1
dev.off()
...
d_R_Mov <- d_R_Mov+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=d_R_Mov), alpha = 0.2)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
  scale_fill_continuous("investments",low="blue",high="red",limits=range(studyArea@data$d_R_Mov))
...
d_R_AC <- d_R_AC+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=d_R_AC), alpha = 0.2)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
  scale_fill_continuous("investments",low="blue",high="red",limits=c(0.00001,max(studyArea@data$d_R_AC,na.rm = T)))
...
#}
#high budget
map_a<-scan(file = 'C:/Users/abaezaca/Documents/MEGADAPT/SHV/outputs/1-240-240-240-0.025-0.025.txt')
for (i in seq(1,length(map_a),13)){
studyArea@data$antiguedad_final_H[which(studyArea@data$AGEB_ID ==map_a[i])]<-  round(map_a[i+1] / 365)
studyArea@data$social_pressure_H[which(studyArea@data$AGEB_ID ==map_a[i])]<-  round(map_a[i+5])
studyArea@data$escazes_final_H[which(studyArea@data$AGEB_ID ==map_a[i])]<-  round(map_a[i+6])
...
map_b<-scan(file = 'C:/Users/abaezaca/Documents/MEGADAPT/SHV/outputs/1-960-240-240-0.025-0.025.txt')
for (i in seq(1,length(map_b),13)){
studyArea@data$antiguedad_final_M[which(studyArea@data$AGEB_ID ==map_b[i])]<-  round(map_b[i+1] / 365)
studyArea@data$social_pressure_M[which(studyArea@data$AGEB_ID ==map_b[i])]<-  round(map_b[i+5])
studyArea@data$escazes_final_M[which(studyArea@data$AGEB_ID ==map_b[i])]<-  round(map_b[i+6])
...
#low
map_C<-scan(file = 'C:/Users/abaezaca/Documents/MEGADAPT/SHV/outputs/1-1680-240-240-0.025-0.025.txt')
for (i in seq(1,length(map_C),13)){
studyArea@data$antiguedad_final_L[which(studyArea@data$AGEB_ID ==map_C[i])]<-  round(map_C[i+1] / 365)
studyArea@data$social_pressure_L[which(studyArea@data$AGEB_ID ==map_C[i])]<-  round(map_C[i+5])
studyArea@data$escazes_final_L[which(studyArea@data$AGEB_ID ==map_C[i])]<-  round(map_C[i+6])
...
studyArea@data<-transform(studyArea@data, z.scarcity_L=cut(studyArea@data$escazes_final_L, breaks=c(0,10,20,40,60)))

studyArea@data<-transform(studyArea@data, z.scarcity_M=cut(studyArea@data$escazes_final_M, breaks=c(0,10,20,40,60)))

studyArea@data<-transform(studyArea@data, z.scarcity_H=cut(studyArea@data$escazes_final_H, breaks=c(0,10,20,40,60)))
...
scarcity_cut_L <- scarcity_cut_L+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.scarcity_L), alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
...
scarcity_cut_M <- scarcity_cut_M+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.scarcity_M), alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
...
scarcity_cut_H <- scarcity_cut_H+geom_polygon(data=studyArea.df,  aes(x=long,y=lat,group=group,fill=z.scarcity_H), alpha = 0.5)+
  geom_path(data=studyArea.df,  aes(x=long,y=lat,group=id),color="white",size=0.05)+
   geom_path(aes(x = long, y = lat, group=id), data = fortify(Munic),colour = 'black', size = .8) +
