...
#cut-offs
studyArea@data<-transform(studyArea@data, z.cut3=cut(antiguedad_diff_M, breaks=c(-32,-15,0,20),labels = c("high","medium","low")))
studyArea@data<-transform(studyArea@data, z.cut5=cut(antiguedad_diff_M, breaks=c(-32,-15,-4,0,6,20),labels = c("very-high","high","medium","low","very-low")))
